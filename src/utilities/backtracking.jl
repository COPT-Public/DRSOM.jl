"""
`BackTrackingEx` specifies a backtracking line-search that uses
...
BackTrackingEx{TF}(args...; kwargs...) where {TF} = BackTrackingEx{TF,Int}(args...; kwargs...)

function (ls::BackTrackingEx)(df, x::AbstractArray{T}, s::AbstractArray{T},
...
(ls::BackTrackingEx)(ϕ, dϕ, ϕdϕ, αinitial, ϕ_0, dϕ_0) = ls(ϕ, αinitial, ϕ_0, dϕ_0)

# TODO: Should we deprecate the interface that only uses the ϕ argument?
function (ls::BackTrackingEx)(ϕ, αinitial::Tα, ϕ_0, dϕ_0) where {Tα}
