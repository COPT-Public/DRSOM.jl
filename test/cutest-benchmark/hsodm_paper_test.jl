...
UNC_PROBLEMS_4to200 = [
    ...
    ["BOXPOWER", "N=10"],
    ["BROWNAL", "N=200"],
    ["BROYDN3DLS", "KAPPA1=2.0,KAPPA2=1.0,N=50"],
    ["BROYDN7D", "N/2=25"],
    ["BROYDNBDLS", "KAPPA1=2.0,KAPPA2=5.0,KAPPA3=1.0,LB=5,N=50,UB=1"],
    ["BRYBND", "KAPPA1=2.0,KAPPA2=5.0,KAPPA3=1.0,LB=5,N=50,UB=1"],
    ["CHAINWOO", "NS=1"],
    ["CHNROSNB", "N=25"],
    ["CHNRSNBM", "N=25"],
    ["COSINE", "N=100"],
    ...
    ["ERRINRSM", "N=25"],
    ["EXTROSNB", "N=100"],
    ["FLETBV3M", "KAPPA=0.0,N=10"],
    ["FLETCBV2", "KAPPA=0.0,N=10"],
    ["FLETCBV3", "KAPPA=0.0,N=10"],
    ["FLETCHBV", "KAPPA=0.0,N=10"],
    ["FLETCHCR", "N=100"],
    ["FMINSRF2", "P=4"],
    ["FMINSURF", "P=4"],
    ["FREUROTH", "N=50"],
    ["GENHUMPS", "N=10,ZETA=20.0"],
    ["GENROSE", "N=100"],
    ["HILBERTA", "D=0.0,N=6"],
    ["HILBERTB", "D=5.0,N=5"],
    ["INDEF", "ALPHA=0.5,N=50"],
    ["INDEFM", "ALPHA=0.5,N=50"],
    ["INTEQNELS", "N=100"],
    ["JIMACK", "M=2,N=2"],
    ["LIARWHD", "N=36"],
    ["MANCINO", "ALPHA=5,BETA=14.0,GAMMA=3,N=50"],
    ["MODBEALE", "ALPHA=50.0,N/2=5"],
    ["MOREBV", "N=50"],
    ["MSQRTALS", "P=7"],
    ["MSQRTBLS", "P=7"],
    ["NCB20", "N=100"],
    ...
    ["NONDQUAR", "N=100"],
    ["NONMSQRT", "P=7"],
    ["OSCIGRAD", "N=15,RHO=500.0"],
    ["OSCIPATH", "N=25,RHO=500.0"],
    ["PENALTY1", "N=50"],
    ["PENALTY2", "N=50"],
    ["PENALTY3", "N/2=25"],
    ["POWELLSG", "N=60"],
    ...
    ["TOINTGSS", "N=50"],
    ["TQUARTIC", "N=50"],
    ["TRIDIA", "ALPHA=2.0,BETA=1.0,DELTA=1.0,GAMMA=1.0,N=50"],
    ["VARDIM", "N=200"],
    ["VAREIGVL", "M=4,N=99,Q=1.5"],
    ["WATSON", "N=12"],
    ["WOODS", "NS=1"],
    ["YATP1LS", "N=10"],
    ["YATP2LS", "N=2"]
...
UNC_PROBLEMS_201to5000 = [
    ["ARWHEAD", "N=1000"],
    ["BDQRTIC", "N=1000"],
    ["BOX", "N=1000"],
    ["BOXPOWER", "N=1000"],
    ["BROWNAL", "N=1000"],
    ["BROYDN3DLS", "KAPPA1=2.0,KAPPA2=1.0,N=1000"],
    ["BROYDN7D", "N/2=250"],
    ["BROYDNBDLS",
        "KAPPA1=2.0,KAPPA2=5.0,KAPPA3=1.0,LB=5,N=1000,UB=1"],
    ["BRYBND", "KAPPA1=2.0,KAPPA2=5.0,KAPPA3=1.0,LB=5,N=1000,UB=1"],
    ["CHAINWOO", "NS=499"],
    ["COSINE", "N=1000"],
    ["CRAGGLVY", "M=499"],
    ["CURLY10", "N=1000"],
    ...
    ["ENGVAL1", "N=1000"],
    ["EXTROSNB", "N=1000"],
    ["FLETBV3M", "KAPPA=0.0,N=1000"],
    ["FLETCBV2", "KAPPA=0.0,N=1000"],
    ["FLETCBV3", "KAPPA=0.0,N=1000"],
    ["FLETCHBV", "KAPPA=0.0,N=1000"],
    ["FLETCHCR", "N=1000"],
    ["FMINSRF2", "P=31"],
    ["FMINSURF", "P=31"],
    ["FREUROTH", "N=1000"],
    ...
    ["GENROSE", "N=500"],
    ["INDEF", "ALPHA=0.5,N=1000"],
    ["INDEFM", "ALPHA=0.5,N=1000"],
    ["INTEQNELS", "N=500"],
    ["JIMACK", "M=2,N=12"],
    ["LIARWHD", "N=1000"],
    ["MODBEALE", "ALPHA=50.0,N/2=1000"],
    ["MOREBV", "N=1000"],
    ["MSQRTALS", "P=70"],
    ["MSQRTBLS", "P=70"],
    ["NCB20", "N=1000"],
    ...
    ["NONDQUAR", "N=1000"],
    ["NONMSQRT", "P=70"],
    ["OSCIGRAD", "N=1000,RHO=500.0"],
    ["OSCIPATH", "N=500,RHO=500.0"],
    ["PENALTY1", "N=1000"],
    ["PENALTY2", "N=1000"],
    ["POWELLSG", "N=1000"],
    ["POWER", "N=1000"],
    ...
    ["TOINTGSS", "N=1000"],
    ["TQUARTIC", "N=1000"],
    ["TRIDIA", "ALPHA=2.0,BETA=1.0,DELTA=1.0,GAMMA=1.0,N=1000"],
    ["VAREIGVL", "M=4,N=499,Q=1.5"],
    ["WOODS", "NS=1000"],
    ["YATP1LS", "N=50"],
    ["YATP2LS", "N=50"]
]
...
UNC_PROBLEMS_COMB = [
    UNC_PROBLEMS_4to200..., UNC_PROBLEMS_201to5000...
]
